...
POST https://api.respeecher.com/v1/public/tts/en-rt/tts/sse
...
Reference: https://space.respeecher.com/docs/space/api/tts/sse
...
- `output_format` (object, optional) — Audio format specification.
  - `encoding` (enum, optional)
    - Allowed values: `pcm_f32le`, `pcm_s16le`, `pcm_mulaw`
