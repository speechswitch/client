  ...
  "paths": {
    "/v1/text-to-speech": {
      "post": {
        ...
        "x-mint": {
          "href": "/api-reference/text-to-speech/text-to-speech"
        },
            ...
            "content": {
              "audio/wav": {
                "schema": {
                  "type": "string",
                  "format": "binary",
                  "description": "WAV audio file binary data. Uncompressed PCM audio with 16-bit depth, mono channel, 44100 Hz sample rate."
                },
        ...
        "description": "Generate speech from text using the specified voice model. Supports emotion, volume, pitch, and tempo customization.\n\nFirst, list all available voice models using the GET /v2/voices endpoint,  then use the voice_id from the response to generate speech with this endpoint. Each voice model has its own unique characteristics. See [Listing all voices](/docs/api-reference/voices/list-voices) for available voices.",
