          ...
          - name: Generation Request
            ...
            properties:
              ...
              - name: voice
                type: oneOf
                description: >-
                  The voice to use for generation. Pass either a voice ID string
                  or an object with a required `id` (additional object fields
                  may be added in future API versions). Use the same value for
                  all generation requests made to the same context. Embeddings
                  are not accepted in this API version.
                required: true
                properties:
                  - name: id
                    type: string
              ...
              - name: language
                type: string
                description: >-
                  Prefer `locale` when you can. `language` only accepts base ISO
                  codes like `en`. A request may set `language` or `locale`,
                  never both. Use the same value for all generation requests
                  made to the same context.
                enumValues:
                  - en
                  - fr
                  - de
              ...
              - name: locale
                type: string
                description: >-
                  Prefer `locale` over `language` (for example `en-GB`).
                  `language` only accepts base codes like `en`. `locale` also
                  accepts regional codes like `en-GB`. Locale codes need Sonic
                  3.6+. A request may set `language` or `locale`, never both.
                  Use the same value for all generation requests made to the
                  same context.
                required: false
              - name: accent
                type: string
                description: >-
                  Usually unnecessary: Cartesia picks the closest accent the
                  voice supports for the requested `language` or `locale`. Set
                  it only to make a [multilingual
                  voice](/build-with-cartesia/capability-guides/multilingual-voices)
                  sound accented (e.g. speak English with a French accent). Must
                  come from the voice's [Get Voice `accents`
              ...
              - name: generation_config
                ...
                properties:
                  ...
                  - name: emotion
                    ...
                    title: Emotion
                    description: >-
                      Optional. If omitted, the model interprets the emotional
                      subtext of the transcript. Must match a valid option
                      exactly.
        ...
        jsonPayloadSchema:
          ...
          properties:
            ...
            voice:
              description: >-
                The voice to use for generation. Pass either a voice ID string
                or an object with a required `id` (additional object fields may
                be added in future API versions). Use the same value for all
                generation requests made to the same context. Embeddings are not
                accepted in this API version.
              oneOf:
                - type: string
                ...
                - type: object
                  ...
                  description: >-
                    Voice object. `id` is required; other fields may be added in
                    future API versions.
                  required:
                    - id
                  properties:
            ...
            language:
              ...
              description: >-
                Prefer `locale` when you can. `language` only accepts base ISO
                codes like `en`. A request may set `language` or `locale`, never
                both. Use the same value for all generation requests made to the
                same context.
              enum:
                - en
                - fr
            ...
            locale:
              ...
              description: >-
                ...
                `language` only accepts base codes like `en`. `locale` also
                accepts regional codes like `en-GB`. Locale codes need Sonic
                3.6+. A request may set `language` or `locale`, never both. Use
                the same value for all generation requests made to the same
                context.
            ...
            accent:
              ...
              description: >-
                ...
                supports for the requested `language` or `locale`. Set it only
                to make a [multilingual
                voice](/build-with-cartesia/capability-guides/multilingual-voices)
                sound accented (e.g. speak English with a French accent). Must
                come from the voice's [Get Voice `accents`
                field](/api-reference/voices/get#response-accents). Learn more
