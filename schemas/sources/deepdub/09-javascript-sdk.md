...
<ParamField body="tempo" type="number">
  Playback speed multiplier, between 0 and 2. Mutually exclusive with `targetDuration`.
</ParamField>
...
<ParamField body="seed" type="number">
  Random seed for deterministic output. Applies to `dd-etts-1.1` only — newer models do not use it, and setting it has no effect on their output.
</ParamField>
