...
<CardGroup cols={2}>
  ...
  <Card title="Streaming Out API" icon="plug" href="/api-reference/websocket/overview">
    Send one complete text and stream the audio back over a WebSocket.
  </Card>

  <Card title="Streaming In and Streaming Out API" icon="arrows-left-right" href="/api-reference/websocket/streaming">
    Stream text in as an LLM produces it and stream the audio back.
  </Card>
</CardGroup>
