...
Sending the selected voice before text arrives also starts optional
[voice preparation](/api-reference/tts/multi-context#prepare-a-voice-before-sending-text).
