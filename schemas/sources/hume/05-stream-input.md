...
Reference: https://dev.hume.ai/reference/text-to-speech-tts/stream-input
...
info:
  title: Stream Input
  version: subpackage_streamInput.streamInput
  description: Generate emotionally expressive speech.
channels:
  /stream/input:
    description: Generate emotionally expressive speech.
    bindings:
        ...
        query:
          ...
          properties:
            ...
            context_generation_id:
              type: string
            format_type:
              $ref: '#/components/schemas//stream/input_format_type'
            ...
            temperature:
              ...
              format: double
            version:
              $ref: '#/components/schemas//stream/input_version'
            api_key:
              type: string
              default: ''
    publish:
      operationId: subpackage_streamInput.streamInput-publish
      summary: subscribe
      message:
        name: subscribe
        title: subscribe
        payload:
          $ref: '#/components/schemas/StreamInputSubscribe'
    subscribe:
      operationId: subpackage_streamInput.streamInput-subscribe
      summary: publish
      message:
        name: publish
        title: publish
        payload:
          $ref: '#/components/schemas/StreamInputPublish'
servers:
  https://api.hume.ai/:
    url: wss://api.hume.ai/v0/tts
    protocol: wss
    x-default: true
components:
  schemas:
    FormatType:
      ...
      enum:
        ...
        - wav
      title: FormatType
    /stream/input_format_type:
      oneOf:
        - $ref: '#/components/schemas/FormatType'
      description: The format to be used for audio generation.
      title: /stream/input_format_type
    TimestampType:
      type: string
      enum:
        - word
    ...
    OctaveVersion:
      ...
      description: >-
        ...
        request. If you omit this field, Hume

        automatically routes the request to the most appropriate model. Setting
        a specific version ensures stable and

        repeatable behavior across requests.


        Use `2` to opt into the latest Octave capabilities. When you specify
        version `2`, you must also provide a

        `voice`. Requests that set `version: 2` without a voice will be
        rejected.


        For a comparison of Octave versions, see the

        [Octave versions](/docs/text-to-speech-tts/overview#octave-versions)
        section in the TTS overview.
      title: OctaveVersion
    /stream/input_version:
      oneOf:
        - $ref: '#/components/schemas/OctaveVersion'
      description: >-
        The version of the Octave Model to use. 1 for the legacy model, 2 for
        the new model.
      title: /stream/input_version
    MillisecondInterval:
      type: object
      properties:
        begin:
    ...
    Timestamp:
      ...
      properties:
        ...
        time:
          ...
          description: >-
            The start and end timestamps for the word or phoneme in
            milliseconds.
        type:
          $ref: '#/components/schemas/TimestampType'
      required:
      ...
      properties:
        ...
        timestamps:
          ...
          description: >-
            ...
            Timestamps are only returned for Octave 2 requests.
        transcribed_text:
          type:
            - string
            - 'null'
        ...
        utterance_index:
          type:
            ...
            - 'null'
          description: >-
            The index of the utterance in the request this snippet corresponds
            to.
      required:
        - audio
        - generation_id
    ...
    TtsOutput:
        ...
        - type: object
          properties:
            ...
            generation_id:
              ...
              format: uuid4
              description: >-
                The generation ID of the parent snippet that this chunk
                corresponds to.
            is_last_chunk:
              type: boolean
              description: >-
                Whether or not this is the last chunk streamed back from the
                decoder for one input snippet.
            request_id:
              type: string
            ...
            transcribed_text:
              type:
                ...
                - 'null'
              description: >-
                The transcribed text of the generated audio of the parent
                snippet that this chunk corresponds to. It is only present if
                `instant_mode` is set to `false`.
            utterance_index:
              type:
                - integer
                - 'null'
              description: >-
                The index of the utterance in the request that the parent
                snippet of this chunk corresponds to.
          required:
            - type
            - audio
            - audio_format
            ...
            - transcribed_text
            - utterance_index
          description: Metadata for a chunk of generated audio.
        - type: object
          properties:
            type:
              type: string
      ...
      discriminator:
        propertyName: type
      title: TtsOutput
    StreamInputSubscribe:
      oneOf:
        - $ref: '#/components/schemas/TtsOutput'
      title: StreamInputSubscribe
    VoiceProvider:
      type: string
      enum:
        - HUME_AI
      ...
      properties:
        ...
        provider:
          ...
          description: >-
            ...
            Library](https://app.hume.ai/tts/voice-library), containing a
            ...
            users. In contrast, your custom voices are private and accessible
            only via requests authenticated with your API key.
      required:
        - id
      title: VoiceId
    VoiceName:
    ...
    InputMessage:
      ...
      properties:
        close:
          type: boolean
          default: false
          description: Force the generation of audio and close the stream.
        description:
          type:
            - string
            - 'null'
          ...
          description: >-
            ...
            **This field behaves differently depending on whether a voice is
            ...
            - **Voice specified**: the description will serve as acting
            directions for delivery. Keep directions concise—100 characters or
            fewer—for best results. See our guide on [acting
        ...
        speed:
          ...
          default: 1
          description: >-
            Speed multiplier for the synthesized speech. Extreme values below
            0.75 and above 1.5 may sometimes cause instability to the generated
            output.
        text:
          type: string
          maxLength: 5000
      ...
      description: Input message type for the TTS stream.
      title: InputMessage
    StreamInputPublish:
      oneOf:
        - $ref: '#/components/schemas/InputMessage'
      title: StreamInputPublish
