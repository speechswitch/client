...
type TtsRequestOctave1TurnsSpeakersItemObjectc72d6ba6VoiceSourceCatalog = Literal["catalog"]

type TtsRequestOctave1TurnsSpeakersItemObjectc72d6ba6VoiceSourceCustom = Literal["custom"]

type TtsRequestOctave1TurnsSpeakersItemObjectc72d6ba6VoiceSource = Union[TtsRequestOctave1TurnsSpeakersItemObjectc72d6ba6VoiceSourceCatalog, TtsRequestOctave1TurnsSpeakersItemObjectc72d6ba6VoiceSourceCustom]

class TtsRequestOctave1TurnsSpeakersItemObjectc72d6ba6(TypedDict):
    ...
    voice_source: ReadOnly[NotRequired[TtsRequestOctave1TurnsSpeakersItemObjectc72d6ba6VoiceSource]]
    reference_samples: ReadOnly[NotRequired[Never]]
    voice_description: ReadOnly[NotRequired[Never]]
    voice_name: ReadOnly[NotRequired[Never]]

class TtsRequestOctave1TurnsSpeakersItemObject62d7994b(TypedDict):
    # TypeScript field: alias.
    # Name used to identify this speaker in dialogue text or turns.
    # Pattern (ECMAScript): ^[\s\S]+$.
    alias: ReadOnly[str]
...
type TtsRequestOctave1TurnsSpeakersItem = Union[TtsRequestOctave1TurnsSpeakersItemObjectc72d6ba6, TtsRequestOctave1TurnsSpeakersItemObject62d7994b]
