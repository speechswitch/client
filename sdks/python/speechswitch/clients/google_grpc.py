...
type AudioEncoding = Literal["AUDIO_ENCODING_UNSPECIFIED", "LINEAR16", "MP3", "OGG_OPUS", "MULAW", "ALAW", "PCM", "M4A"]
_AudioEncoding_values: dict[AudioEncoding, int] = {"AUDIO_ENCODING_UNSPECIFIED":0,"LINEAR16":1,"MP3":2,"OGG_OPUS":3,"MULAW":5,"ALAW":6,"PCM":7,"M4A":8}
...
STREAMING_SYNTHESIZE_PATH = "/google.cloud.texttospeech.v1.TextToSpeech/StreamingSynthesize"
