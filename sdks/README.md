...
source acquisition and limitations. Respeecher's Go and Rust types are generated;
their adapters remain to be implemented on the same provider-scoped branch.
