...
Voice.ai has a Python adapter for modern/legacy byte-streaming HTTP and native
multi-context WebSockets. Model-specific types, validators and context-correlated
output types are generated for all three languages. Go and Rust adapters are next
on the same Voice.ai provider branch.
