...
target.RawPath = strings.TrimSuffix(target.EscapedPath(), "/") + "/v1/text:synthesize"
target.Path = strings.TrimSuffix(target.Path, "/") + "/v1/text:synthesize"
...
target.RawPath = strings.TrimSuffix(target.EscapedPath(), "/") + "/v1/voices"
target.Path = strings.TrimSuffix(target.Path, "/") + "/v1/voices"
target.RawQuery = query.Encode()
var body []byte
