...
func requests() []schema.TtsRequest {
	...
	c := request()
	c.Value.Model = schema.TtsRequestTextfd2d056aModelAsS21Pro{}
	...
	d := request()
	d.Value.Model = schema.TtsRequestTextfd2d056aModelAsS21ProFree{}
	...
	h := schema.TtsRequestAsTextfd2d056a{Value: schema.TtsRequestTextfd2d056a{Model: schema.TtsRequestTextfd2d056aModelAsS2Pro{}, Text: "<|speaker:0|>Hello<|speaker:1|>Hi", Output: schema.TtsRequestS1TextOutputAsMp3{}, Speakers: schema.TtsRequestTextfd2d056aSpeakersAsArraybc859dfb{Value: []schema.TtsRequestTextfd2d056aSpeakersArraybc859dfbItem{{Voice: "a"}, {Voice: "b"}}}}}
	i := h
	i.Value.Speakers = schema.TtsRequestTextfd2d056aSpeakersAsArray66345558{Value: []schema.TtsRequestTextfd2d056aSpeakersArray66345558Item{{ReferenceSamples: []schema.TtsRequestS1TextReferenceSamplesItem{{Audio: []byte{1, 2}, Text: "a"}}}, {ReferenceSamples: []schema.TtsRequestS1TextReferenceSamplesItem{{Audio: []byte{3, 4}, Text: "b"}}}}}
...
func TestEveryRequestVariantAndPointerConvertsWithoutPolling(t *testing.T) {
	...
	model := schema.TtsRequestTextfd2d056aModelAsS2Pro{}
	speakers := schema.TtsRequestTextfd2d056aSpeakersAsArraybc859dfb{Value: []schema.TtsRequestTextfd2d056aSpeakersArraybc859dfbItem{{Voice: "custom-voice"}}}
	...
	e := schema.TtsRequestAsTextfd2d056a{Value: schema.TtsRequestTextfd2d056a{Model: model, Text: "hello", Output: output, Speakers: speakers}}
	f := schema.TtsRequestAsStreamingTexta6bb52c3{Value: schema.TtsRequestStreamingTexta6bb52c3{Model: model, Text: input, Output: output, Speakers: speakers}}
	g := schema.TtsRequestAsText698033d1{Value: schema.TtsRequestText698033d1{Model: model, Text: "hello", Output: output, ReferenceSamples: samples}}
	h := schema.TtsRequestAsStreamingText327a2fba{Value: schema.TtsRequestStreamingText327a2fba{Model: model, Text: input, Output: output, ReferenceSamples: samples}}
