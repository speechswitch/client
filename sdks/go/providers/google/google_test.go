...
func TestAllCanonicalRequestBranches(t *testing.T) {
	...
	requests := []schema.TtsRequest{
		...
		schema.TtsRequestAsTurns4e097198{Value: schema.TtsRequestTurns4e097198{Model: flashSpeakers, Language: "en-US", Speakers: speakers, Turns: []Turn{{Speaker: "Sam", Text: "hello"}}, Output: wav}},
		schema.TtsRequestAsTurns35afe3cc{Value: schema.TtsRequestTurns35afe3cc{Model: flashSpeakers, Language: "en-US", Speakers: speakers, Turns: []Turn{{Speaker: "Sam", Text: "hello"}}, Output: pcm}},
