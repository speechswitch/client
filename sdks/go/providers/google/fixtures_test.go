...
func TestSharedWireFixtures(t *testing.T) {
	...
	typed := map[string]schema.TtsRequest{
		...
		"gemini-dialogue-http": schema.TtsRequestAsTurns4e097198{Value: schema.TtsRequestTurns4e097198{
		...
		"gemini-dialogue-native": schema.TtsRequestAsTurns35afe3cc{Value: schema.TtsRequestTurns35afe3cc{
			Model: flashSpeakers, Language: "en-US", Speakers: speakers, Turns: []Turn{{Speaker: "Sam", Text: "Hi"}}, Instructions: runtime.Some("Conversational"), Output: schema.TtsRequestChirp3Hda92b414cOutputAsOggOpus{},
		}},
