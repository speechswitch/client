...
const pyRespeecherErrors = JSON.parse(run("pyright", ["--outputjson", "tests/invalid_respeecher.py"], python, 1).stdout);
...
testdata/invalidgoogle/invalid.go:7:91: cannot use schema.TtsRequestChirp3HdTextVoiceffbf1cc1OutputAsMp3{} (value of struct type google.TtsRequestChirp3HdTextVoiceffbf1cc1OutputAsMp3) as google.TtsRequestChirp3InstantCustomVoiceTextVoiced9d056deOutput value in assignment: google.TtsRequestChirp3HdTextVoiceffbf1cc1OutputAsMp3 does not implement google.TtsRequestChirp3InstantCustomVoiceTextVoiced9d056deOutput (missing method isTtsRequestChirp3InstantCustomVoiceTextVoiced9d056deOutput)
testdata/invalidgoogle/invalid.go:8:66: cannot use schema.TtsRequestTextVoiceModelAsGemini25FlashLitePreviewTts{} (value of struct type google.TtsRequestTextVoiceModelAsGemini25FlashLitePreviewTts) as google.TtsRequestTextModel value in assignment: google.TtsRequestTextVoiceModelAsGemini25FlashLitePreviewTts does not implement google.TtsRequestTextModel (missing method isTtsRequestTextModel)
testdata/invalidgoogle/invalid.go:9:67: r.VolumeDb undefined (type *google.TtsRequestObjecta65cbd8a has no field or method VolumeDb)
testdata/invalidgoogle/invalid.go:10:68: cannot use schema.TtsRequestChirp3HdTextVoiceffbf1cc1OutputAsWav{} (value of struct type google.TtsRequestChirp3HdTextVoiceffbf1cc1OutputAsWav) as google.TtsRequestChirp3Hd174648a4Output value in assignment: google.TtsRequestChirp3HdTextVoiceffbf1cc1OutputAsWav does not implement google.TtsRequestChirp3Hd174648a4Output (missing method isTtsRequestChirp3Hd174648a4Output)
...
testdata/invalidvocu/invalid.go:4:13: request.SubtitleFormat undefined (type *"github.com/speechswitch/client/sdks/go/generated/vocu".TtsRequestTextVoicee296d426 has no field or method SubtitleFormat)
testdata/invalidvocu/invalid.go:6:53: unknown field Model in struct literal of type "github.com/speechswitch/client/sdks/go/generated/vocu".TtsRequestTextVoice9c5ed44a
testdata/invalidvocu/invalid.go:7:57: unknown field ReferenceEmphasis in struct literal of type "github.com/speechswitch/client/sdks/go/generated/vocu".TtsRequestTextVoice9c5ed44a
testdata/invalidvocu/invalid.go:8:51: unknown field Voice in struct literal of type "github.com/speechswitch/client/sdks/go/generated/vocu".TtsRequestText8f38e545
testdata/invalidvocu/invalid.go:9:24: undefined: out.SynthesisItemAsClear
testdata/invalidvocu/invalid.go:10:63: cannot use runtime.Input[string](nil) (value of interface type "github.com/speechswitch/client/sdks/go/runtime".Input[string]) as string value in struct literal
testdata/invalidvocu/invalid.go:11:74: cannot use out.SynthesisItemAsDone{} (value of struct type vocu_output.SynthesisItemAsDone) as "github.com/speechswitch/client/sdks/go/generated/vocu".TtsRequest value in argument to provider.Synthesize: vocu_output.SynthesisItemAsDone does not implement "github.com/speechswitch/client/sdks/go/generated/vocu".TtsRequest (missing method isTtsRequest)
`);
